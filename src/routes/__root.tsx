  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">No route here</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          SurfaceScan has nothing mapped at this address.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          Scan console stopped
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          SurfaceScan hit an unexpected state loading this view. Reload to continue.
        </p>
